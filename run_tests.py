...
def run_all_tests():
    ...
    tests = [
        ...
        (
            "test_segments_to_text_concatenation",
            lambda: test_segments_to_text_concatenation(fixtures_segments),
        ),
        ...
        (
            "test_format_segments_for_prompt",
            lambda: test_format_segments_for_prompt(fixtures_segments),
        ),
        # Video Clipper
    ...
    try:
        ...
        tests.extend(
            [
                ...
                (
                    "test_api_process_missing_source",
                    lambda: test_api_process_missing_source(client),
                ),
                ...
                (
                    "test_api_download_endpoints",
                    lambda: test_api_download_endpoints(client, fixtures_result),
                ),
                (
                    "test_api_serve_media_forbidden_and_not_found",
                    lambda: test_api_serve_media_forbidden_and_not_found(client),
                ),
            ]
        )
